...
export default function Sidebar() {
  ...
  return (
    <div 
      className={`fixed left-0 top-0 h-screen bg-[#131420] flex flex-col items-start py-5 transition-all duration-300 ease-in-out z-50 overflow-y-auto scrollbar-hide ${
